...
public class CompleteDNSClient{
...
//	public static  byte[] intToTwoBytes(int a){
	...
	/*public static byte[] readMessage(DataInputStream din) throws IOException {
		...
		public static String MessageIDGenerator() {
			int minimum = 1000;
			int maximum = 8999;
		...
		public static void main(String[] args) {
			...
			String Type = constructQueryClass("PTR");
			String Class = "0001";
			String Name = ToHexString("cs621_cache");
			String mdnsQuery = MessageID + "01000001000000000000" + Name + Type + Class;
			// this the original hex string of message length(not 2 bytes),right shift to create 0000000000000020 from 20.
			...
			for(int t =0; t <timeOfExp; t++){
				for(int k=0; k< 0; k++){
					...
					String _MessageID = MessageIDGenerator();
					String _newS = "";
					if(protocol.equals("tcp"))
